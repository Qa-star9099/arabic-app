...
import 'package:arabic_app/app/theme/app_colors.dart';
import 'package:arabic_app/app/theme/app_typography.dart';
import 'package:arabic_app/features/placement_test/controllers/placement_test_controller.dart';
import 'package:arabic_app/features/placement_test/models/test_question.dart';
import 'package:arabic_app/app/router/app_router.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Column(
      ...
      children: [
        Text(
          question.difficulty,
          style: AppTypography.body.copyWith(color: AppColors.emerald, fontWeight: FontWeight.bold),
        ),
          ...
          Row(
            children: [
              ...
              Text(
                ...
                style: AppTypography.heading2.copyWith(color: isCorrect ? AppColors.emerald : AppColors.error),
              ),
            ],
          ),
          if (!isCorrect) ...[
            ...
            Text(correctAnswerText, style: AppTypography.heading3.copyWith(color: AppColors.error)),
          ],
        ],
      ),
    );
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: isSubmitted ? (isAnswerSelected ? AppColors.emerald : AppColors.primary) : AppColors.primary,
              disabledBackgroundColor: const Color(0xFF334155),
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
            ),
            child: Text(
              isSubmitted ? "DAVOM ETISH" : "TEKSHIRISH",
              style: AppTypography.heading3.copyWith(color: isAnswerSelected || isSubmitted ? Colors.white : Colors.white54),
            ),
          ),
        ),
      ),
